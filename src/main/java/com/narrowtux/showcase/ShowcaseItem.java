...
public class ShowcaseItem {
	...
	public void setLocation(Location location) {
		location = location.getBlock().getLocation(); // simply clear everything
														// after the comma.
	...
	/*
	 * public void giveItemsBack(){ if(type.equals(ShowcaseType.FINITE_SHOP)){
