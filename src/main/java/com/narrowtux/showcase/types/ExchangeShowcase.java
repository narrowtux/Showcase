...
public class ExchangeShowcase implements ShowcaseProvider {
	...
	public void addPagesToCreationWizard(ShowcaseCreationAssistant assistant) {
		/*
		 * Wizard: How many items of (type) you want to sell? Take the item you
		 * want to get for this one in your hand (type ok), or type id:data Type
		 * the exchangerate (x:y)
		 */
